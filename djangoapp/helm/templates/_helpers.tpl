...
{{/*
Helloworld env settings
*/}}
{{- define "helloworld.settings" -}}
- name: DJANGO_DEBUG
  value: {{ .Values.helloworld.settings.debug | quote }}
- name: DJANGO_ALLOWED_HOST
  value: {{ default "*" .Values.helloworld.settings.allowed_host | quote }}
- name: DJANGO_SETTINGS_MODULE
  value: {{ .Values.helloworld.settings.module | quote }}
{{- end -}}
